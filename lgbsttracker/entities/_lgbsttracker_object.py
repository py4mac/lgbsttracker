...
class _LGBSTTrackerObject(object):
    def __iter__(self):
...
def to_string(obj):
    return _LGBSTTrackerObjectPrinter().to_string(obj)
...
class _LGBSTTrackerObjectPrinter(object):

    def __init__(self):
        super(_LGBSTTrackerObjectPrinter, self).__init__()
        self.printer = pprint.PrettyPrinter()

    def to_string(self, obj):
        if isinstance(obj, _LGBSTTrackerObject):
